...
import { TestServiceButton } from "./TestServiceButton/TestServiceButton";
  ...
  <>
    ...
    <footer className={styles.footer}>
      <div className={styles.footer__content}>
        <div className={styles.footer__test}>
          <p>
            Want to test the functionality?
            <br />
            We have such an opportunity!
          </p>
          <TestServiceButton className={styles.footer__test__button} />
        </div>
        <p className={styles.footer__copyright}>
          © SecureCloud {`${new Date().getFullYear()}`}
          <br />
          All rights reserved
        </p>
      </div>
